<?php
/**
 * ltbp-wp functions and definitions.
 *
...
if ( ! function_exists( 'ltbp_wp_setup' ) ) :
/**
 ...
 */
function ltbp_wp_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on ltbp-wp, use a find and replace
	 * to change 'ltbp-wp' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'ltbp-wp', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'ltbp-wp' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'ltbp_wp_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif;
add_action( 'after_setup_theme', 'ltbp_wp_setup' );
 ...
 */
function ltbp_wp_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'ltbp-wp' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'ltbp-wp' ),
...
add_action( 'widgets_init', 'ltbp_wp_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'ltbp_wp_scripts' );
